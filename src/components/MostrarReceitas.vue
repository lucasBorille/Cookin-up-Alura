...
export default{
    ...
    async created(){
        ...
        this.receitasEncontradas = receitas.filter(r =>r.ingredientes.every(elemento => this.ingredientes.includes(elemento)))
    },
...
<template>
    <section class="mostrar-receitas">
        ...
        <div v-else class="receitas-nao-encontradas">
            ...
            <img src="/src/assets/images/sem-receitas.png" alt="Desenho de um ovo quebrado. A gema tem um rosto com uma expressão triste.">
        </div>
